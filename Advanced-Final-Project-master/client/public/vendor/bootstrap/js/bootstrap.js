...
(function() {
    ...
    const _createClass = (function() {
        function defineProperties(target, props) { for (let i = 0; i < props.length; i++) { const descriptor = props[i];
    ...
    const Alert = (function($) {
        ...
        const Alert = (function() {
            ...
            Alert.prototype._removeElement = function _removeElement(element) {
                ...
                $(element).one(Util.TRANSITION_END, (event) => _this2._destroyElement(element, event)).emulateTransitionEnd(TRANSITION_DURATION);
            };
        ...
        const Carousel = (function() {
            ...
            Carousel.prototype._addEventListeners = function _addEventListeners() {
                ...
                if (this._config.pause === 'hover') {
                    $(this._element).on(Event.MOUSEENTER, (event) => _this4.pause(event)).on(Event.MOUSELEAVE, (event) => _this4.cycle(event));
                    if ('ontouchstart' in document.documentElement) {
                        ...
                        $(this._element).on(Event.TOUCHEND, () => {
                            ...
                            _this4.touchTimeout = setTimeout((event) => _this4.cycle(event), TOUCHEVENT_COMPAT_WAIT + _this4._config.interval);
                        });
                    }
                }
            };
        ...
        const Collapse = (function() {
            ...
            Collapse._jQueryInterface = function _jQueryInterface(config) {
                return this.each(function() {
                    const $this = $(this);
                    let data = $this.data(DATA_KEY);
                    const _config = $.extend({}, Default, $this.data(), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config);
    ...
    const Dropdown = (function($) {
        ...
        const Dropdown = (function() {
            ...
            Dropdown._jQueryInterface = function _jQueryInterface(config) {
                return this.each(function() {
                    let data = $(this).data(DATA_KEY);
                    const _config = (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' ? config : null;
        ...
        $(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Dropdown._dataApiKeydownHandler).on(Event.KEYDOWN_DATA_API, Selector.MENU, Dropdown._dataApiKeydownHandler).on(`${Event.CLICK_DATA_API} ${Event.KEYUP_DATA_API}`, Dropdown._clearMenus)
    ...
    const Modal = (function($) {
        ...
        const Modal = (function() {
            ...
            Modal.prototype.show = function show(relatedTarget) {
                ...
                $(this._element).on(Event.CLICK_DISMISS, Selector.DATA_DISMISS, (event) => _this10.hide(event));
            ...
            Modal.prototype.hide = function hide(event) {
                ...
                if (transition) {
                    $(this._element).one(Util.TRANSITION_END, (event) => _this11._hideModal(event)).emulateTransitionEnd(TRANSITION_DURATION);
                } else {
                    this._hideModal();
                }
            };
            ...
            Modal._jQueryInterface = function _jQueryInterface(config, relatedTarget) {
                return this.each(function() {
                    let data = $(this).data(DATA_KEY);
                    const _config = $.extend({}, Modal.Default, $(this).data(), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config);
    ...
    const ScrollSpy = (function($) {
        ...
        const ScrollSpy = (function() {
            function ScrollSpy(element, config) {
                ...
                $(this._scrollElement).on(Event.SCROLL, (event) => _this20._process(event));
            ...
            ScrollSpy._jQueryInterface = function _jQueryInterface(config) {
                return this.each(function() {
                    let data = $(this).data(DATA_KEY);
                    const _config = (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config;
        ...
        const Tooltip = (function() {
            ...
            Tooltip.prototype._setListeners = function _setListeners() {
                ...
                triggers.forEach((trigger) => {
                    if (trigger === 'click') {
                        $(_this26.element).on(_this26.constructor.Event.CLICK, _this26.config.selector, (event) => _this26.toggle(event));
                    } else if (trigger !== Trigger.MANUAL) {
                        const eventIn = trigger === Trigger.HOVER ? _this26.constructor.Event.MOUSEENTER : _this26.constructor.Event.FOCUSIN;
                        const eventOut = trigger === Trigger.HOVER ? _this26.constructor.Event.MOUSELEAVE : _this26.constructor.Event.FOCUSOUT;

                        $(_this26.element).on(eventIn, _this26.config.selector, (event) => _this26._enter(event)).on(eventOut, _this26.config.selector, (event) => _this26._leave(event));
                    }

                    $(_this26.element).closest('.modal').on('hide.bs.modal', () => _this26.hide());
                });
            ...
            Tooltip.prototype._fixTitle = function _fixTitle() {
                const titleType = _typeof(this.element.getAttribute('data-original-title'));
