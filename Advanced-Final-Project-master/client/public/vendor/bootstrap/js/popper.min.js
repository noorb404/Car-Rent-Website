 ...
 */(function (e, t) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = t() : typeof define === 'function' && define.amd ? define(t) : e.Popper = t(); }(this, () => {
	function e(e) { return e && {}.toString.call(e) === '[object Function]'; } function t(e, t) { if (e.nodeType !== 1) return []; const o = window.getComputedStyle(e, null); return t ? o[t] : o; } function o(e) { return e.nodeName === 'HTML' ? e : e.parentNode || e.host; } function n(e) { if (!e || ['HTML', 'BODY', '#document'].indexOf(e.nodeName) !== -1) return window.document.body; const i = t(e); const r = i.overflow; const p = i.overflowX; const s = i.overflowY; return /(auto|scroll)/.test(r + s + p) ? e : n(o(e)); } function r(e) { const o = e && e.offsetParent; const i = o && o.nodeName; return i && i !== 'BODY' && i !== 'HTML' ? ['TD', 'TABLE'].indexOf(o.nodeName) !== -1 && t(o, 'position') === 'static' ? r(o) : o : window.document.documentElement; } function p(e) { const t = e.nodeName; return t !== 'BODY' && (t === 'HTML' || r(e.firstElementChild) === e); } function s(e) { return e.parentNode === null ? e : s(e.parentNode); } function d(e, t) { if (!e || !e.nodeType || !t || !t.nodeType) return window.document.documentElement; const o = e.compareDocumentPosition(t) & Node.DOCUMENT_POSITION_FOLLOWING; const i = o ? e : t; const n = o ? t : e; const a = document.createRange(); a.setStart(i, 0), a.setEnd(n, 0); const f = a.commonAncestorContainer; if (e !== f && t !== f || i.contains(n)) return p(f) ? f : r(f); const l = s(e); return l.host ? d(l.host, t) : d(e, s(t).host); } function a(e) { const t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'top'; const o = t === 'top' ? 'scrollTop' : 'scrollLeft'; const i = e.nodeName; if (i === 'BODY' || i === 'HTML') { const n = window.document.documentElement; const r = window.document.scrollingElement || n; return r[o]; } return e[o]; } function f(e, t) { const o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]; const i = a(t, 'top'); const n = a(t, 'left'); const r = o ? -1 : 1; return e.top += i * r, e.bottom += i * r, e.left += n * r, e.right += n * r, e; } function l(e, t) { const o = t === 'x' ? 'Left' : 'Top'; const i = o == 'Left' ? 'Right' : 'Bottom'; return +e[`border${o}Width`].split('px')[0] + +e[`border${i}Width`].split('px')[0]; } function m(e, t, o, i) { return _(t[`offset${e}`], o[`client${e}`], o[`offset${e}`], ie() ? o[`offset${e}`] + i[`margin${e === 'Height' ? 'Top' : 'Left'}`] + i[`margin${e === 'Height' ? 'Bottom' : 'Right'}`] : 0); } function h() { const e = window.document.body; const t = window.document.documentElement; const o = ie() && window.getComputedStyle(t); return { height: m('Height', e, t, o), width: m('Width', e, t, o) }; } function c(e) { return { ...e, right: e.left + e.width, bottom: e.top + e.height }; } function g(e) {
		...
		}; const d = Object.keys(s).map((e) => ({ key: e, ...s[e], area: v(s[e]) })).sort((e, t) => t.area - e.area); const a = d.filter((e) => { const t = e.width; const i = e.height; return t >= o.clientWidth && i >= o.clientHeight; }); const f = a.length > 0 ? a[0].key : d[0].key; const l = e.split('-')[1]; return f + (l ? `-${l}` : '');
		...
		onUpdate() {},
		modifiers: {
			shift: { order: 100, enabled: !0, fn(e) { const t = e.placement; const o = t.split('-')[0]; const i = t.split('-')[1]; if (i) { const n = e.offsets; const r = n.reference; const p = n.popper; const s = ['bottom', 'top'].indexOf(o) !== -1; const d = s ? 'left' : 'top'; const a = s ? 'width' : 'height'; const f = { start: pe({}, d, r[d]), end: pe({}, d, r[d] + r[a] - p[a]) }; e.offsets.popper = { ...p, ...f[i] }; } return e; } },
			offset: {
			...
			computeStyle: {
				...
				enabled: !0,
				fn(e, t) {
					const o = t.x; const i = t.y; const n = e.offsets.popper; const p = T(e.instance.modifiers, (e) => e.name === 'applyStyle').gpuAcceleration; void 0 !== p && console.warn('WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!'); let s; let d; const a = void 0 === p ? t.gpuAcceleration : p; const f = r(e.instance.popper); const l = g(f); const m = { position: n.position }; const h = {
						left: V(n.left), top: V(n.top), bottom: V(n.bottom), right: V(n.right),
					}; const c = o === 'bottom' ? 'top' : 'bottom'; const u = i === 'right' ? 'left' : 'right'; const b = B('transform'); if (d = c == 'bottom' ? -l.height + h.bottom : h.top, s = u == 'right' ? -l.width + h.right : h.left, a && b)m[b] = `translate3d(${s}px, ${d}px, 0)`, m[c] = 0, m[u] = 0, m.willChange = 'transform'; else { const y = c == 'bottom' ? -1 : 1; const w = u == 'right' ? -1 : 1; m[c] = d * y, m[u] = s * w, m.willChange = `${c}, ${u}`; } const v = { 'x-placement': e.placement }; return e.attributes = { ...v, ...e.attributes }, e.styles = { ...m, ...e.styles }, e;
				},
				gpuAcceleration: !0,
				x: 'bottom',
				y: 'right',
